...
const TotalAllocation = ({ allocation, onConfirm, onReset }) => (
  ...
  <div className="row border rounded  border-lightgray content-color">
    ...
    <span className={"border " + (allocation <100?' border-danger':' border-success') } style={{backgroundColor:"white"}}>
 {allocation} % </span>
    </div>
    <div className="col-md-3 align-self-center p-1">
      <span className="small align-self-center font-weight-bold" style={{color:"#052948"}}> Total Allocation </span>
    </div>
